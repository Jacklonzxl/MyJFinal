...
INSERT INTO `biz_channel_sms_req` VALUES (1,2,NULL,'13378485310','http://127.0.0.1/admin/?pg=biz/channelSms&m1=m_biz&m2=m_biz_channelSms&path=/biz/channelSms','http://127.0.0.1/admin/?pg=biz/channelSms&m1=m_biz&m2=m_biz_channelSms&path=/biz/channelSms',NULL,'321',4,'2016-04-10 17:13:17','2016-04-10 23:56:02');
...
CREATE TABLE `biz_channel_url_cnt` (
  ...
  `thedate` varchar(30) DEFAULT NULL COMMENT '日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='渠道链接统计表';
...
CREATE TABLE `biz_channel_url_log` (
  ...
  `created_at` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='渠道链接访问日志';
