...
<div class="toolbar row">
	<div class="col-sm-6 hidden-xs">
		<div class="page-header">
			<h1>角色信息 <small>查看及管理角色信息</small></h1>
		</div>
	</div>
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				...
				<tr>
					...
					<td class="hidden-xs">${list.value}</td>
					<td class="hidden-xs">${list.intro}</td>
				...
				<c:forEach begin="1" end="${psize}" var="pageSize">
			       ...
			       <c:if test="${pageSize!=pageNum}"> 		      
				   <li><a href="javascript:loadUrl('${path}?pageNum=${pageSize}')">${pageSize}</a></li>
				   </c:if>
				  </c:if>
				  </c:forEach> 
