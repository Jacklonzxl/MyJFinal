...
<div class="toolbar row">
	<div class="col-sm-6 hidden-xs">
		<div class="page-header">
			<h1>用户信息 <small>查看及管理用户信息</small></h1>
		</div>
	</div>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				...
				<label>&nbsp;&nbsp;&nbsp;&nbsp;用户组:&nbsp;
				<select size="1" id="group_id" name="group_id" style="min-width:100px" >
				<option value="-1">-全部-</option>
				<c:forEach items="${groupList}" var="list">
				<option value="${list.id}" <c:if test="${param.group_id==list.id}">selected</c:if> >${list.name}</option>
				</c:forEach> 
				</select>
				</label>
				<label>&nbsp;&nbsp;&nbsp;&nbsp;状态:&nbsp;
				...
				<tr>
					...
					<td  class="hidden-xs">${list.username}</td>
					<td class="hidden-xs">${list.full_name}</td>				
					<td class="hidden-xs">${list.group_name}</td>
