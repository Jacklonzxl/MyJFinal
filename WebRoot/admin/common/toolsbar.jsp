						...
						<ul>
								...
								<a href="javascript:;" class="unread">
									<div class="clearfix">
										<div class="thread-image">
											<img src="./${pageContext.request.contextPath}/ui/assets/images/avatar-2.jpg" alt="">
										</div>
							...
							<li>
								<a href="javascript:;" class="unread">
									<div class="clearfix">
										<div class="thread-image">
											<img src="./${pageContext.request.contextPath}/ui/assets/images/avatar-3.jpg" alt="">
										</div>
										<div class="thread-content">
							...
							<li>
								<a href="javascript:;">
									<div class="clearfix">
										<div class="thread-image">
											<img src="./${pageContext.request.contextPath}/ui/assets/images/avatar-5.jpg" alt="">
										</div>
										<div class="thread-content">
