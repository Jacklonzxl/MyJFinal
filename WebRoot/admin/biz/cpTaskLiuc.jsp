...
<div class="toolbar row">
	<div class="col-sm-6 hidden-xs">
		<div class="page-header">
			<h1>留存信息 <small>查看及管理留存信息</small></h1>
		</div>
	</div>
	...
	<div class="col-md-12">
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				...
				<option value="0" <c:if test="${param.status=='0'}">selected</c:if> >未开始</option> 
				</select> &nbsp;&nbsp;&nbsp;&nbsp;关键字:&nbsp;</label>
				...
				<tr>
					...
					<td class="hidden-xs">${list.channel}</td>				
					<td class="hidden-xs">${list.packname}</td>
					<td class="hidden-xs">${list.liucs}</td>
					<td class="hidden-xs"><c:if test="${list.status==0}">未开始</c:if><c:if test="${list.status==1}">已完成</c:if></td>
					<td class="center">
