...
<div class="toolbar row">
	<div class="col-sm-6 hidden-xs">
		<div class="page-header">
			<h1>渠道短信接口信息 <small>查看及管理渠道短信接口信息</small></h1>
		</div>
	</div>
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				...
				<tr>
					...
					<th class="hidden-xs">接口名称</th>
					<th class="hidden-xs">获取地址</th>
					<th class="hidden-xs">提交地址</th>
				...
				<tr>
					...
					<td class="hidden-xs">${list.advertiser}</td>				
					<td class="hidden-xs">${list.name}</td>
					<td class="hidden-xs" style="width:20%;word-break:break-all;">${list.geturl}</td>
					<td class="hidden-xs" style="width:20%;word-break:break-all;">${list.posturl}</td>
