...
<div class="toolbar row">
	<div class="col-sm-6 hidden-xs">
		<div class="page-header">
			<h1>渠道信息 <small>查看及管理渠道信息</small></h1>
		</div>
	</div>
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				...
				<tr>
					...
					<td class="hidden-xs">${list.prov}</td>				
					<td class="hidden-xs">${list.city}</td>
					<td class="hidden-xs">${list.content}</td>
					...
					<div class="visible-md visible-lg hidden-sm hidden-xs">
					    ...
					    &nbsp;&nbsp;&nbsp;
					   <div class="btn-group">
						 <button data-toggle="dropdown" class="btn btn-xs btn-blue dropdown-toggle">
						 <i class="fa fa-ellipsis-h"></i>
						 更多<span class="caret"></span>
						 </button>
						 <ul class="dropdown-menu" role="menu">
						 <li>
						 <a href="javascript:loadPage('/biz/channelUrl?channelid=${list.id}','#','m_biz','m_biz_channelUrl')">
						 <i class="fa fa-link"></i>&nbsp;链接管理
						  </a>
						 </li>
						 <li>
						 <a href="javascript:loadPage('/biz/channelSms?channelid=${list.id}','#','m_biz','m_biz_channelSms')">
						  <i class="fa fa-envelope"></i>&nbsp;短信接口
						 </a>
						  </li>						 
						 </ul>
						 </div>
