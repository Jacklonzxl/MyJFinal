     ...
     <br/>
      ...
      <table class="table" id="tablelist">
       ...
       <tr>
        ...
        <td style="text-align:center;width:150px">${list.serverid}</td>
        <td style="text-align:center;width:100px">
         <c:if test="${list.readstatus!=0}">打开</c:if>
         <c:if test="${list.readstatus==0}">关闭</c:if>
        </td>
        <td style="text-align:center;width:280px">
         <c:if test="${list.followstatus!=0}">打开</c:if>
         <c:if test="${list.followstatus==0}">关闭</c:if>
        </td>
