...
<%@ taglib uri="/WEB-INF/tld/fn.tld" prefix="fn" %>
     <!--弹出框效果-->
       ...
       <form action="${pageContext.request.contextPath}/wx/${m_name}/save" method="post" id="form1" target="iframe1">
        ...
        <input type="hidden" id="type" name="bean.type" value="2">
        <input type="hidden" id="aid" name="bean.aid" value="0">
        <ul>
         <!--<li>
         	<span>用&nbsp;&nbsp;&nbsp;户</span>
         ...
         <li>
          <span>省&nbsp;&nbsp;&nbsp;份</span>
          <input type="text" id="prov" name="bean.prov"  value="${bean.prov}" style="width:33%"  placeholder="" class="textbox"/>
          <span>&nbsp;&nbsp;&nbsp;城&nbsp;&nbsp;&nbsp;市&nbsp;</span>
          <input type="text" id="city" name="bean.city" value="${bean.city}" style="width:32.3%" placeholder="" class="textbox"/>
         </li> 
         <li>
          <span>关注数</span>
          <input type="text" id="maxfollow" name="bean.maxfollow" value="${bean.maxfollow}" placeholder="设置单个公众号最大关注数" style="width:32.6%" class="textbox" onkeyup="setonkeyup(this,100000)"/>
          <span>&nbsp;&nbsp;&nbsp;阅读数&nbsp;</span>
          <input type="text" id="maxread" name="bean.maxread" value="${bean.maxread}" placeholder="设置单个条链接最大阅读数" style="width:32.3%"  class="textbox" onkeyup="setonkeyup(this,1000000)"/>
         </li>
      
          <li>
          <span>日&nbsp;&nbsp;&nbsp;限</span>
          <input type="text" id="max_day_follow" name="bean.max_day_follow" value="${bean.max_day_follow}" placeholder="" class="textbox" style="width:33%"   onkeyup="setonkeyup(this,100000000)"/>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="text" id="max_day_read" name="bean.max_day_read" value="${bean.max_day_read}" placeholder="" class="textbox" style="width:32.3%"   onkeyup="setonkeyup(this,100000000)"/>
         </li> 
        <li>
          <span>单&nbsp;&nbsp;&nbsp;价</span>
