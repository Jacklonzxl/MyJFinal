     ...
     <!--弹出框效果-->
       ...
       <form action="${pageContext.request.contextPath}/wx/readtask/save" method="post" id="form2" target="iframe2">
        ...
        <ul>
         <li>
          <span>标&nbsp;&nbsp;&nbsp;题</span>
          <input type="text" id="title" name="bean.title" value="${bean.title}" placeholder="" class="textbox"/>
         </li>
         <li>
          <span>链&nbsp;&nbsp;&nbsp;接</span>
          <input type="text" id="url" name="bean.url"  value="${bean.url}" placeholder="" class="textbox"/>
         </li>
         <li>
          <span>阅读数</span>
         ...
         <li>
          <span>点赞数</span>
          <input type="text" id="praise_quantity" name="bean.praise_quantity" value="${bean.praise_quantity}"  placeholder="0" class="textbox"/>
         </li>
