...
<%@ taglib uri="/WEB-INF/tld/fn.tld" prefix="fn" %>
     <!--弹出框效果-->
       ...
       <form action="${pageContext.request.contextPath}/wx/${m_name}/insave" method="post" id="form2" target="iframe2">
        ...
        <ul>
         ...
         <li>
          <span>透支额度:</span>
          <input type="text" id="borrow" name="bean.borrow" value="${bean.borrow}"  disabled="disabled" placeholder="" class="textbox"  />
         </li>
         <li>
          <span>充值金额:</span>
          <input type="text" id="borrow" name="money" value=""   placeholder="" class="textbox"  />
         </li>
         <li>
          <span>充值类型:</span>
            <select class="select" style="height:32px;width:83.8%" id="type" name="type">
