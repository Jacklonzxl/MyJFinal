...
<form action="#" method="post" id="form1" name="form1" target="iframe1" >
     ...
     <div class="page_title">
       <h2 class="fl">阅读明细列表</h2>
       <!-- <a class="fr top_rt_btn">右侧按钮</a> -->
 
      </div>
             
     <section style="padding-top:10px">
		      <input type="button" value="返回"  class="link_btn" onclick="clickmenu('reporttask')" />
      ...
      &nbsp;&nbsp;<input type="button"  class="link_btn"   onclick="loadtable('readingDetail',1);"  value="查询"/>
      </div>
     </section> 
     <section>
     <br/>
