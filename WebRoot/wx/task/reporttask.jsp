...
<form action="#" method="post" id="form1" name="form1" target="iframe1" >
     ...
     <section style="padding-top:10px">
      ...
      &nbsp;&nbsp;<input type="button"  class="link_btn"   onclick="loadtable('reporttask',1);"  value="查询"/>
      </div>
     </section> 
     <section>
     <br/>
      ...
      <table class="table" id="tablelist">
       ...
       <tr>
        ...
        <td style="text-align:center;">
         <c:if test="${count!=i-1}"><a href="javascript:updatequery_order_time('readingDetail','${list.thedate}')">查看明细</a></c:if>
        </td>
       </tr>
       </c:forEach>    
      </table>
