...
<html lang="zh-CN" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>报表-每小时数据监控(<%=request.getParameter("date")%>)</title>
...
<a href="listhours?type=1&date=<%=request.getParameter("date")%>&fr=<%=request.getParameter("fr")%>">天下通</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="listhours?type=2&date=<%=request.getParameter("date")%>&fr=<%=request.getParameter("fr")%>">平安好房</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="listhours?type=3&date=<%=request.getParameter("date")%>&fr=<%=request.getParameter("fr")%>">咪咕阅读(注册)</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="listhours?type=5&date=<%=request.getParameter("date")%>&fr=<%=request.getParameter("fr")%>">咪咕阅读(沈阳)</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="listhours?type=4&date=<%=request.getParameter("date")%>&fr=<%=request.getParameter("fr")%>">亿百润</a>
<br/>
<br/>
<strong>
...
<tr>
	<th style="width:200px">时间</th><th style="width:300px">数量</th>
</tr>
<% 
